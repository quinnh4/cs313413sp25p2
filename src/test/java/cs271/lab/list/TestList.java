...
public class TestList {
  ...
  public void testContains() {
    // this makes sure list doesnt include 77 before adding
    assertEquals(false, list.contains(77));
    list.add(77);
    // this makes sure list does include 77 after adding
  ...
  public void testContainsAll() {
    ...
    list.add(77);
    list.add(66);
    // used containsAll and List.of (see above),
  ...
  public void testSet() {
    ...
    list.add(77);
    list.add(66);
    // used the set method to change specific elements in the list
